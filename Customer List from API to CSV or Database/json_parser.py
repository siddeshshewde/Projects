...
with open(csv_customer_list, 'rb') as csvfile:
	...
	for row in reader:
		...
		request_list.append('http://172.16.201.30:8081/adminviewStormLive/rule/{customer_id}/hp/provider?pdt={product_type}'.format(customer_id = row[0], product_type = row[1]))
